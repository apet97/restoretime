...
| ID | Subject | Defends |
|---|---|---|
| UT-N01 | Webhook guard: rejects malformed bodies (missing IDs, invalid timestamps, a stopped entry without an end timestamp, and wrong types) | Contract violation handling |
